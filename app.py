...
DATA_PATH = "data_files/data.parquet"
...
def main():
    ...
    X_train = load_x_y("data_files/X_train.pkl")
    X_test = load_x_y("data_files/X_test.pkl")
    y_train = load_x_y("data_files/y_train.pkl")
    y_test = load_x_y("data_files/y_test.pkl")
